...
public class DenominationFiveHundred implements DispensableDenomination {
	...
	Denominations currentDenomination = Denominations.FIVEHUNDRED;
	
	public DenominationFiveHundred(DispensableDenomination processDenomination){
