...
public class DenominationHundred implements DispensableDenomination {
	...
	Denominations currentDenomination = Denominations.HUNDRED;
	
	public DenominationHundred(DispensableDenomination processDenomination){
